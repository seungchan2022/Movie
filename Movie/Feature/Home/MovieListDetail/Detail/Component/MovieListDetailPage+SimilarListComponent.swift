...
extension MovieListDetailPage {
  struct SimilarListComponent {
    let viewState: ViewState
    let tapAction: () -> Void
  }
}

extension MovieListDetailPage.SimilarListComponent {
  var itemList: [MovieAPIModel.Detail.Similar.Response.Item]? {
    viewState.similar?.itemList
  }
}
...
extension MovieListDetailPage.SimilarListComponent: View {
  var body: some View {
    if let itemList {
      VStack {
...
extension MovieListDetailPage.SimilarListComponent {
  struct ViewState: Equatable {
    let similar: MovieAPIModel.Detail.Similar.Response?
  }
}
